    ...
    fun onCoroutineGetResult(coroutineScope: CoroutineScope, activity: Activity, displaySearchBinding: DisplaySearchBinding){
        coroutineScope.launch {
            ...
            when(submenu){
                ...
                "giatui" -> {
                    val getResultDeffered = API.apiService.getShopGiatUiByName(newString)
                    try{
                        val arrList = getResultDeffered.await()
                        displaySearchBinding.progressBarInSearch.visibility = View.VISIBLE
                        val len = arrList.size - 1
                ...
                "hoa" -> {
                    val getResultDeffered = API.apiService.getShopHoaByName(newString)
                    try{
                        val arrList = getResultDeffered.await()
                        displaySearchBinding.progressBarInSearch.visibility = View.VISIBLE
                        val len = arrList.size - 1
                ...
                "lamdep" -> {
                    val getResultDeffered = API.apiService.getShopLamDepByName(newString)
                    try{
                        val arrList = getResultDeffered.await()
                        displaySearchBinding.progressBarInSearch.visibility = View.VISIBLE
                        val len = arrList.size - 1
                ...
                "ruoubia" -> {
                    val getResultDeffered = API.apiService.getShopRuouBiaByName(newString)
                    try{
                        val arrList = getResultDeffered.await()
                        displaySearchBinding.progressBarInSearch.visibility = View.VISIBLE
                        val len = arrList.size - 1
                ...
                "sieuthi" -> {
                    val getResultDeffered = API.apiService.getShopSieuThiByName(newString)
                    try{
                        val arrList = getResultDeffered.await()
                        displaySearchBinding.progressBarInSearch.visibility = View.VISIBLE
                        val len = arrList.size - 1
                ...
                "thucung" -> {
                    val getResultDeffered = API.apiService.getShopThuCungByName(newString)
                    try{
                        val arrList = getResultDeffered.await()
                        displaySearchBinding.progressBarInSearch.visibility = View.VISIBLE
                        val len = arrList.size - 1
                ...
                "thuoc" -> {
                    val getResultDeffered = API.apiService.getShopThuocByName(newString)
                    try{
                        val arrList = getResultDeffered.await()
                        displaySearchBinding.progressBarInSearch.visibility = View.VISIBLE
                        val len = arrList.size - 1
